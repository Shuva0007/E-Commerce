...
function Filter() {
    ...
    const { mode, setProducts, searchkey, filterPrice, setFilterPrice, setSearchkey, filterType, setFilterType, product ,location1} = context

    return (
        <div>
            <div className=' container mx-auto px-4 mt-5 '>
                <div className="p-8 rounded-lg bg-gray-100 drop-shadow-xl border border-#181c24 bg-blue-500"
                    style={{
                        backgroundColor: mode === 'dark' ? '#282c34' : '',
                        color: mode === 'dark' ? 'white' : '',
                    }}>
                    <div className="relative ">
                        <div className="absolute flex items-center ml-2 h-full fill-sky-950">
                        ...
                        <input
                            ...
                            className="px-8 py-3 w-full rounded-md bg-violet-0 border-sky-950 outline-0 text-sm" style={{ backgroundColor: mode === 'dark' ? 'rgb(64 66 70)' : '', color: mode === 'dark' ? 'white' : '', }} />
                    </div>
                    <div className="flex items-center justify-between mt-4 text-black">
                        <p className="font-medium">
                            Filters
                        </p>
                    <button onClick={location1} className="px-4 py-2 bg-gray-50 hover:bg-gray-200 text-gray-800 text-sm font-medium rounded-md text-black" style={{ color: mode === 'dark' ? 'black' : '' }}>
                            Reset Filter
                        </button>
                    </div>
                    <div>
